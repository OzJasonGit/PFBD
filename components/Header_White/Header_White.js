          ...
          <header id={styles.FIXED_HEADER}>
            ...
            <div className="content-center ..." id={styles.NAV_MENU}>
              <Link className="content-center ..." id={styles.SERVICES} href="/plastic_free_by_design">
                <h3 id={styles.H_3_SERVICES} className="text-center ...  text-stone-700 font-avant_garde_bold" data-content="Home">
                  Home
                </h3>
              </Link>
              ...
              <Link id={styles.NEWSLETTER} href="/newsletter">
                <h3 id={styles.H_3_NEWSLETTER} className="text-center ...  text-stone-700  font-avant_garde_bold" data-content="Newsletter">
                  Newsletter
                </h3>
              </Link>
              <Link id={styles.STORIES} href="/bloghome">
                <h3 id={styles.H_3_STORIES} className="text-center ...  text-stone-700 font-avant_garde_bold" data-content="Blog">
                  Blog
                </h3>
              </Link>
            </div>

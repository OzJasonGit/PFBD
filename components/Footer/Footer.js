                        ...
                        <div id={styles.FOOTER_MAIN}>
                            ...
                            <div id={styles.TC}>
                                <div id={styles.COMPANY}>
                                    ...
                                    <br/>
                                    <h4 id={styles._H4}  class="text-stone-400 ... font-avant_garde_medium text-xs ... text-right"><a class= "text-emerald-200 ... font-avant_garde_bold"><Link href="/">plasticfreebydesign.com</Link></a> 

          ...
          <Drawer
              ...
              id={styles.DRAWER_LEFT  }
                ...
                title= {<h1  id={styles.H_3} class="text-right ...  text-stone-700 font-avant_garde_bold">
                        <Link class="text-4xl" href="/plastic_free_by_design">
                           <div>
                            <Image 
                              id={styles.CENTER}
                              src={logoBC}   
              ...
              <div id={styles.DRAWER_MENU}>
                ...
                <Link class="content-center ..." id={styles.SERVICES} href="/plastic_free_by_design"> 
                    <h3 id={styles._H2} class="text-right ...  text-stone-700 font-avant_garde_bold"><a class="">Home</a></h3>
                </Link>  

                <Link id={styles.PRODUCTS} href="/products"> 
                  <h3 id={styles._H2} class="text-right ...  text-stone-700  font-avant_garde_bold"><a class="">Products</a></h3>
                </Link>  

                <Link id={styles.NEWSLETTER} href="/newsletter"> 
                  <h3 id={styles._H2} class="text-right ...  text-stone-700  font-avant_garde_bold"><a class="">Newsletter</a></h3>
                </Link>  
                ...
                <Link id={styles.WELCOME} href="/welcome_page"> 
                  <h3 id={styles._H2} class="text-right ...  text-stone-700  font-avant_garde_bold"><a class="">Welcome</a></h3>
                </Link>  
                ...
                <div id={styles.TEXT}>
                    <div id={styles.COMPANY}>
                        ...
                        <br/>
                        <h4 id={styles._H4}  class="text-stone-700 ... font-avant_garde_bold text-xs ... text-left"><a class= "text-emerald-400 ... font-avant_garde_bold"><Link href="/">plasticfreebydesign.com</Link></a> 
